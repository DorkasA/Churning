...
st.markdown("<h4 style = 'margin: -30px; color: #F11A7B; text-align: center; font-family: tangerine'> Built By:DORCAS AKPULONU</h4>", unsafe_allow_html = True)
st.markdown("<br>", unsafe_allow_html= True)

st.image('8m44Ap1VON-removebg-preview.png', use_column_width=True)
...
st.sidebar.image('bank_case_study_illust-1024x576.png', caption='Welcome User')
