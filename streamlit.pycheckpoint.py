...
st.markdown("<h4 style = 'margin: -30px; color: #F11A7B; text-align: center; font-family: tangerine'> Built By: ADEWALE JOLAYEMI</h4>", unsafe_allow_html = True)
...
st.sidebar.image('pngwing.com (9).png', caption='Welcome User')
